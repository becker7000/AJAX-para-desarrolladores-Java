...
public class ValidarFormularioBServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try(PrintWriter salida = resp.getWriter()) {
            if(errores.isEmpty()){
                ...
                salida.println("    </head>");
                salida.println("    <body>");
                salida.println("        <h1>Validando formulario básico</h1>");
                ...
                errores.forEach( error ->
                        salida.println("<br/><font color=\"red\">Error: "+error+"</font>"));
            }
        }
